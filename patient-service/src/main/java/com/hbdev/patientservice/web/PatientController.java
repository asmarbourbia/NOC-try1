...
public class PatientController {
    ...
    public ResponseEntity<Patient> createPatient(@RequestParam("first_name") String firstName,
        ...
        try {
            ...
            patient.setGender(gender); // Set the gender field
            patient.setDateOfBirth(java.sql.Date.valueOf(dateOfBirth)); // Ensure the date format is correct
   ...
   /* @PostMapping("/{id}/upload-cin")
    ...
    public ResponseEntity<Patient> getPatientById(@PathVariable Long id) {
        try {
            Patient patient = patientService.findById(id); // Ensure this method exists in PatientService
